...
/**
 * Class representing sudoku board used for testing.
 * Constructs Sudoku from strings and validates it.
 *
 * CAUTION! Rows and columns are indexed from 0 to size-1.
 * Cells are filled with numbers from 1 to 9.
 */
class SudokuBoardTester extends SudokuBoard {

    public SudokuBoardTester(String str) throws InvalidBoardException {
        super(boardFromLine(str));
    }

    public SudokuBoardTester(int[][] board) {
        super(board);
    }
    ...
    public boolean isDerivedFrom(SudokuBoardTester oldSudokuBoard) {
